    ...
    <div className="pt-20">
      ...
      <div className="text-center px-8">
        ...
        <div className="flex flex-col items-center max-w-xs mx-auto gap-4 sm:justify-center sm:flex-row sm:inline-flex">
          <Link
            href="#calendly"
            className="w-full justify-center flex items-center whitespace-normal transition duration-150 ease-in-out font-medium rounded px-4 py-1.5 text-zinc-900 bg-gradient-to-r from-white/80 via-white to-white/80 hover:bg-white group"
            data-aos="fade-down"
            data-aos-delay="400"
          >
            Book a free call{" "}
